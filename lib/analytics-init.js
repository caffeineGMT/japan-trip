...
(function() {
  ...
  // PostHog configuration - read from meta tags injected by server
  ...
  const POSTHOG_CONFIG = {
    apiKey: getMetaContent('posthog-api-key') || 'phc_YOUR_PROJECT_API_KEY', // Replace with your actual PostHog API key
    apiHost: getMetaContent('posthog-host') || 'https://app.posthog.com', // Or your self-hosted instance
  };
